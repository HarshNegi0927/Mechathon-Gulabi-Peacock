...
export default function BudgetDashboard() {
  ...
  const fetchBudgets = async () => {
    try {
      const response = await fetch('https://mechathon-gulabi-peacock-8.onrender.com/api/budget', {
        credentials: 'include'
      })
  ...
  const handleCreateBudget = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch('https://mechathon-gulabi-peacock-8.onrender.com/api/budget/create', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateSpent = async (budgetId, categoryName, spent) => {
    try {
      const response = await fetch('https://mechathon-gulabi-peacock-8.onrender.com/api/budget/category/spent', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleArchiveBudget = async (budgetId) => {
    try {
      const response = await fetch(`https://mechathon-gulabi-peacock-8.onrender.com/budget/archive/${budgetId}`, {
        method: 'PUT',
        credentials: 'include'
      })
  ...
  const handleUpdateBudget = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`https://mechathon-gulabi-peacock-8.onrender.com/api/budget/edit/${editBudgetId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
