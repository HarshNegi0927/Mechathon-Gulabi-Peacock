...
export default function ExpenseTracker() {
  ...
  const fetchBudgets = useCallback(async () => {
    try {
      const response = await axios.get('https://mechathon-gulabi-peacock-10.onrender.com/api/budget', {
  ...
  const fetchExpenses = useCallback(async (budgetId) => {
    ...
    try {
      const response = await axios.get(`https://mechathon-gulabi-peacock-10.onrender.com/api/budget/expenses/${budgetId}`, {
        withCredentials: true,
      });
      if (response.status === 200) {
...
const updateCategorySpent  = useCallback(async (budgetId,categoryName,amount) =>{
  try {
    const response = await axios.put('https://mechathon-gulabi-peacock-10.onrender.com/api/budget//category/spent',{
...
useEffect(() => {
  ...
  const addExpense = useCallback(async () => {
    ...
    try {
      const response = await axios.post('https://mechathon-gulabi-peacock-10.onrender.com/api/budget/addExpenses', {
