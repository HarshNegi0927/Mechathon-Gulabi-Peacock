          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span>support@ticktracker.com</span>
              </div>
              <div className="flex items-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                />
              </div>
              <div>
